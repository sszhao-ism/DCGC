...
#     # dis_min = pairwise_distance_function(X, initial_state_best).sum()
#     for i in range(20):
...
def initialize(X, num_clusters):
    ...
    if X.shape[0] < num_clusters:
        raise ValueError("The number of clusters cannot be larger than the number of samples.")
...
def kmeans(
    ...
    if initial_state_best is None:
        raise RuntimeError("Failed to initialize cluster centers.")
    initial_state = initial_state_best
